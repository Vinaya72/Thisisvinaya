...
<body>
    <header class="l-header">
       <nav class="navigation">
           <div>
              <a href="#banner" class="nav-logo">Vinaya</a>
           </div>
           <div class="nav-main">
               <ul class="alignment">
           ...
           <div class="nav-menu" id="nav-menuu">
            <ul>
        ...
        <div class="nav-toggle" id="nav-togglee">
    ...
    <main>
            ...
            <div class="main-main">
                <div class="banner-img">
                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="100%" height="100%"
                     viewBox="0 0 888 677.20705" xmlns:xlink="http://www.w3.org/1999/xlink">
                     <polygon points="307.693 659.535 316.417 662.148 330.648 629.74 317.772 625.884 307.693 659.535"
                      fill="#ffb8b8"/><path d="M462.32048,767.41626l17.18156,5.1462.00069.00021a11.43063,11.43063,0,0,1,7.66935,14.22912l-.10659.35581-28.13113-8.4259Z"
                       transform="translate(-156 -111.39648)" fill="#2f2e41"/>
                       <polygon points="390.602 666.663 399.153 663.528 391.13 629.055 378.51 633.682 390.602 666.663" fill="#ffb8b8"/>
                       <path d="M543.39769,776.06729l16.83948-6.17423.00068-.00025a11.43063,11.43063,0,0,1,14.6658,6.79715l.12785.34873L547.46038,787.1476Z"
                        transform="translate(-156 -111.39648)" fill="#2f2e41"/>
       ...
       <section id='skills'>
           <div data-aos="flip-left" class="title">
                 Skills
           </div>
            ...
            data-aos-anchor-placement="top-center"> 
              <div class="grid-item">
                  <i class="fas fa-laptop-code"></i> Front-end Development
                   <ul class="point">
                       <li>HTML and CSS</li>
                       <li>Bootstrap</li>
                       <li>React JS</li>
              ...
              <div class="grid-item">
                  <i class="fas fa-mobile-alt"></i> Mobile Application Development
                  <ul class="point">
                      <li>React Native</li>
                      <li>Android in Java</li>
                  </ul>
              </div>
              <div class="grid-item">
              ...
              <div class="grid-item">
                  <i class="fas fa-object-ungroup"></i> UX/UI Design
                  <ul class="point">
                      <li>Figma</li>
                  </ul>
              </div>
       ...
       <section id='work'>
        <div data-aos="flip-up" class="title">Work Experience</div>
            ...
            data-aos-anchor-placement="top-center">
              ...
              <div class="timeline-sec">
                <h2 class="date">Sepetember 2021 - November 2021</h2>
                <div class="timeline-content">
                    <h1>LEARNOVATE Ecommerce - Web Developer</h1>
                    <p>Participated in webinar| Explored new concepts |
                      Developed Front end part of different webpages 
                    </p>
                </div>
              </div>
            </div>
    ...
    <section id='projects'>
        <div data-aos="flip-right" class="title">
            Projects
      </div>
      ...
      data-aos-anchor-placement="top-center">
        <div class="card">
          <div class="content">
            ...
            <p class="copy">Android with Java</p>
           <a href="https://github.com/Vinaya72/Simple-Chat-App" class="project-link">View Code</a>
          </div>
        </div>
        <div class="card">
          <div class="content">
            <h2 class="title">Weather App</h2>
            <p class="copy">React Native + Open weather map</p>
            <a href="https://expo.dev/@vinaya_02/weatherap" class="project-link">View App</a>
          </div>
        </div>
        <div class="card">
          <div class="content">
            <h2 class="title">Todo App + Note</h2>
            <p class="copy">React Native + Firebase</p>
            <a href="https://expo.dev/@vinaya_02/TodoApp" class="project-link">View App</a>
          </div>
        </div>
        <div class="card">
          <div class="content">
            <h2 class="title">Space Shooter</h2>
            <p class="copy">Unity</p>
            <a href="https://github.com/Vinaya72/Space-Shooter" class="project-link">View Code</a>
          </div>
        </div>
      </div>
  </section>
...
<footer class="footer section">
  <div class="footer__container">
        <div class="footer__data">
            <h2 class="footer__title">Thanks for the time.</h2>
        ...
        <div class="footer__data">
            ...
            <ul>
                <li><a href="#banner" class="footer__link">About me</a></li>
                <li><a href="#skills" class="footer__link">Skills</a></li>
                <li><a href="#work" class="footer__link">Work Experience</a></li>
        ...
        <div class="footer__data">
            <h2 class="footer__title">Follow</h2>
             <a href="https://in.linkedin.com/in/vinaya-sourabha-harikrishnan-470493216" class="footer__social text-center"><i class="fab fa-linkedin"></i></a>
